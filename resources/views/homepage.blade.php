...
@include('subjects.newsub')
      ...
      <fieldset>
        <div class="row my-3 gy-4">
            ...
            <h1 class = "homepage">WELCOME, USER!</h1>
                ...
                <div class="row justify-content-center">
                  <div class="col-sm-12">
                    <div class="d-grid gap-4 text-center">
                      <div class="row">
                        <div class="col-md-4">
                          <button class="btn btn-primary create btn-create" type="button" onclick="location.href='http://www.example.com'">View User</button>
                        </div>
                        <div class="col-md-4">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <button class="btn btn-primary create btn-create" type="button">Create User</button>
                          </a>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <a data-bs-toggle="modal" data-bs-target="#registerSubModal">
                          <button class="btn btn-primary create btn-create" type="button">Create Subject</button>
                          </a>
                        </div>
                      </div>
                    </div>
