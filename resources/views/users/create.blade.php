                    ...
                    <fieldset>
                        ...
                        <div class="form-outline input-field pb-2" id="ifStudent">
                            {{-- If student (RFID)--}}
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter a 8-12 digit RFID UID" name="rfid_number" id='rfid_numberInput' pattern="[0-9]+" minlength="8" maxlength="12" required>
